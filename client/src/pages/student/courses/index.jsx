  ...
  console.log(loadingState, "loadingState");
    ...
    return (
      <div className="container mx-auto p-4 bg-gray-900 text-white">
        <h1 className="text-3xl font-bold mb-4 text-indigo-400">All Courses</h1>
          ...
          <main className="flex-1">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex items-center gap-2 p-5 bg-gray-800 border border-gray-700 text-gray-300 hover:bg-gray-700"
                  >
                    <ArrowUpDownIcon className="h-4 w-4 text-indigo-400" />
                    <span className="text-[16px] font-medium">Sort By</span>
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent
                  align="end"
                  className="w-[180px] bg-gray-800 border border-gray-700"
                >
                  <DropdownMenuRadioGroup
                    value={sort}
            ...
            <div className="space-y-4">
              {studentViewCoursesList && studentViewCoursesList.length > 0 ? (
                  ...
                  >
                    <CardContent className="flex gap-4 p-4">
                      ...
                      <div className="flex-1">
                        <CardTitle className="text-xl mb-2 text-indigo-400">
                          {courseItem?.title}
                        </CardTitle>
                ...
                <h1 className="font-extrabold text-4xl text-red-500">
                  No Courses Found
                </h1>
              )}
            </div>
